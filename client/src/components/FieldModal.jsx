...
import { createField } from '../services/fieldApi';

const FieldModal = ({ isOpen, onClose, onFieldAdded }) => {
    ...
    useEffect(() => {
        if (isOpen && !mapRef.current) {
            mapRef.current = L.map('map', {
                ...
                attributionControl: false // Removed Leaflet watermark
            }).setView([20, 77], 4);
    ...
    return (
        <div className="fixed inset-0 flex justify-center items-center backdrop-blur-md bg-black bg-opacity-30">
            <div className="p-3 m-2 rounded-lg shadow-lg w-96"
                ...
                <h2 className="text-2xl font-bold text-center text-white">Add New Field</h2>
